...
use Og\OptimaClass\Components\Routehelper;
...
class Cms
{
    ...
    private static $image_url = 'https://crm.optimaventurez.com/images/cms_medias/'; // For resize image URLs
    private static $image_url_users = ' https://crm.optimaventurez.com/images/users/'; // For getUsers image URLs
    private static $image_url_without_resize = 'https://crm.optimaventurez.com/images/cms_medias/'; // For svg images URLs
    ...
    */
    ...
    public static function ResizeImage($url, $size = 1200, $type = 'cms_medias')
    {
        ...
        return self::$image_url . $settings['site_id'] . '/' . $name; // as we are not using size in the image url
